...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'hidden lg:flex fixed left-0 top-0 z-40 h-screen bg-slate-900/80 backdrop-blur-xl border-r border-white/5 transition-all duration-300 flex-col',
          recolhido ? 'w-20' : 'w-64'
        )}
      >
        {sidebarContent}
      ...
      <aside
        className={cn(
          'lg:hidden fixed left-0 top-0 z-50 h-screen w-72 bg-slate-900/95 backdrop-blur-xl border-r border-white/5 flex flex-col transition-transform duration-300 ease-in-out',
