...
const projetos: Projeto[] = [
  ...
  },
  {
    ...
    descricaoLonga: 'Sistema completo para análise de conteúdo qualitativo usando o Método Bardin. A assistente Sofia guia você pelas 3 fases: Pré-Análise, Exploração e Tratamento dos Resultados.',
    icone: FileSearch,
    cor: 'purple',
    ...
    categoria: 'pesquisa',
    destaque: true,
    features: ['Método Bardin', 'Assistente Sofia IA', 'Codificação automática'],
  },
  {
    id: 'stress-test',
