...
const projetos: Projeto[] = [
  {
    ...
    href: 'https://inteia-analise-politica-2026.vercel.app/',
    externo: true,
    status: 'novo',
    categoria: 'pesquisa',
    destaque: true,
  ...
  {
    id: 'analise-ibaneis-2026',
    nome: 'Análise Ibaneis Senado 2026',
    descricao: 'Estudo estratégico para candidatura ao Senado',
    descricaoLonga: 'Análise completa da viabilidade de Ibaneis ao Senado 2026. Interdependência com Celina, cenário de 2 vagas e recomendações estratégicas.',
    icone: TrendingUp,
    cor: 'blue',
    corGradiente: 'from-blue-500 to-indigo-500',
    href: '/analise-ibaneis-2026/index.html',
    externo: true,
    status: 'ativo',
    categoria: 'pesquisa',
    features: ['Disputa 2 vagas', 'Chapa Celina+Ibaneis', 'Helena IA'],
  },
  {
    id: 'relatorio-celina',
    nome: 'Relatório Celina Leão 2026',
    descricao: 'Análise científica de intenção de voto',
    descricaoLonga: 'Evolução da intenção de voto de Celina Leão para Governadora do DF. Análise de 2 anos de pesquisas com gráficos interativos.',
    icone: BarChart3,
    cor: 'green',
    corGradiente: 'from-green-500 to-emerald-500',
    href: '/relatorio-celina/index.html',
    externo: true,
    status: 'ativo',
    categoria: 'pesquisa',
  ...
  },
  {
    ...
    descricao: 'Método Bardin com assistente IA Sofia',
    descricaoLonga: 'Sistema em desenvolvimento para análise de conteúdo qualitativo usando o Método Bardin. A assistente Sofia guiará você pelas 3 fases: Pré-Análise, Exploração e Tratamento.',
    icone: FileSearch,
    cor: 'purple',
    corGradiente: 'from-purple-500 to-violet-500',
    href: 'https://frontend-3t83ucjoc-igormorais123s-projects.vercel.app',
    externo: true,
    status: 'beta',
    categoria: 'pesquisa',
    destaque: false,
    features: ['Método Bardin', 'Assistente Sofia IA', 'Em desenvolvimento'],
  },
];
